...
class CodexAppServerTransport:
    ...
    def _developer_instructions(self) -> str:
        return (
            ...
            "lease_token, and client_request_id from xmuse_context. On retry "
            "after uncertainty or error, reuse the exact same arguments and "
            "client_request_id without changing the selected outcome. Do not call "
