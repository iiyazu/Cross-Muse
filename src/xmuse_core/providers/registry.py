...
DEFAULT_CODEX_ORDINARY_MODEL_ID = "gpt-5.6-luna"
DEFAULT_CODEX_MODEL_ID = DEFAULT_CODEX_ORDINARY_MODEL_ID
DEFAULT_CODEX_GOD_MODEL_ID = "gpt-5.6-sol"
DEFAULT_CODEX_REVIEW_MODEL_ID = "gpt-5.6-sol"
DEFAULT_CODEX_WORKER_MODEL_ID = DEFAULT_CODEX_ORDINARY_MODEL_ID
