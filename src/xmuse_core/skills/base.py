...
class SkillContext:
    ...
    feature_root: Path = field(default_factory=lambda: XMUSE_ROOT / "work" / "features")
    prompt_dir: Path = field(default_factory=lambda: XMUSE_ROOT / "prompts")
    lanes_path: Path = field(default_factory=lambda: XMUSE_ROOT / "feature_lanes.json")
