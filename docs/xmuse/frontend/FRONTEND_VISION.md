...
type ParticipantInit = {
  ...
  provider_id?: string;            // public provider identity, e.g. "codex"
  profile_id?: string;             // public provider profile, e.g. "god" | "review"
  cli_kind?: "codex";              // legacy adapter compatibility only
...
type RoleTemplate = {
  ...
  provider_id: string;           // public provider identity, currently "codex"
  profile_id: string;            // "god" | "review" | "worker" | "default"
  cli_kind: "codex";
