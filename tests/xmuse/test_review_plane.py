...
def test_final_action_hold_create_is_idempotent_for_verdict(tmp_path: Path) -> None:
    gate_store = FinalActionGateStore(tmp_path / "final_actions.json")

    first = gate_store.create_hold(
        lane_id="lane-hold",
        verdict_id="verdict-hold",
        action="merge",
        target_status="reviewed",
        summary="ready",
    )
    second = gate_store.create_hold(
        lane_id="lane-hold",
        verdict_id="verdict-hold",
        action="merge",
        target_status="reviewed",
