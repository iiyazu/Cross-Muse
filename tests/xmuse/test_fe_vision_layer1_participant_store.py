...
class TestModelShapes:
    ...
    def test_role_template_fields(self):
        ...
        assert fields == {
            "id", "slug", "display_name", "prompt", "provider_id", "profile_id", "cli_kind",
            "default_model", "predefined", "created_at", "updated_at",
        }
    ...
    def test_participant_cli_kind_literal(self):
        p = Participant(
            ...
            display_name="d", provider_id="codex", profile_id="default",
...
class TestParticipantStore:
    ...
    def test_add_rejects_claude(self, participant_store, conversation):
    ...
    def test_list_by_conversation_isolation(self, chat_store, participant_store, db_path):
        ...
        participant_store.add(
            ...
            display_name="rev", cli_kind="codex", model="gpt-5.5",
        )
...
class TestRoleTemplateStoreSeeding:
    ...
    def test_seeding_refreshes_existing_predefined_execute_prompt(
        self,
        db_path,
        chat_store,
    ):
        ...
        with sqlite3.connect(db_path) as conn:
            conn.execute(
                ...
                set prompt = ?
                where slug = ? and predefined = 1
                """,
                ('{"type": "done", "summary": "<old>"}', "execute"),
            )

        refreshed = RoleTemplateStore(db_path).get_by_slug("execute")
