...
def test_peer_chat_mcp_endpoint_exposes_writeback_and_explicit_handoff_tools(
    ...
    response_description = tools["chat_record_collaboration_response"]["description"]
    assert "proof_boundary" in response_description
    assert "command, not allowed_command" in response_description
