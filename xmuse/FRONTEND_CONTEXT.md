...
> 当前独立前端开发入口请优先阅读 `xmuse/FRONTEND_IMPLEMENTATION_GUIDE.md`、
> `xmuse/FRONTEND_API.md`、`xmuse/FRONTEND_API_INCREMENTAL.md`、
...
下面表格保留为历史背景；当前接口以 `xmuse/FRONTEND_API.md` 和
`xmuse/FRONTEND_IMPLEMENTATION_GUIDE.md` 为准。
