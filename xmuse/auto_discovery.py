...
def default_feature_lanes_path() -> Path:
    return default_xmuse_root(Path("xmuse")) / "feature_lanes.json"
...
def discover(
    *,
    ...
    existing_ids = load_existing_feature_ids(lanes_path or default_feature_lanes_path())
